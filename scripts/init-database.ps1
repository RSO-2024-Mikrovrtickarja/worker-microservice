...
Write-Log -Name "Initialization" -Content "Creating database microscale_storage..."
Invoke-Expression "$PostgresPsqlBinary -h localhost -U postgres -c `"CREATE DATABASE microscale_storage ENCODING UTF8`""
